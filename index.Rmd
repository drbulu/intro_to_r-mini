...
<br/>
<h4>Data Science (John Hopkins University):</h4>  
...
<br/>
<h4>Other Online Sources such as...</h4>
1. Quick-R: http://www.statmethods.net/index.html  
2. R bloggers: http://www.r-bloggers.com/  

For more information consult:  
<p style="text-align:center;font-size:40px"><b style="color:red;text-decoration:underline;" >Googlz of the interwebz!</b></p>

--- .class #id 
<br/>
<br/>
    <div align="center" >
        <h1 style="color:red;text-decoration:underline;font-size:100px;" >Thank you!</h1>
    </div>  
<br/>  
<div>
    <p style="text-align:center">
        <b>And now for a shameless plug!!</b><br/>  
    </p>
    <br>  
    <p>
        These are presentation links: click <b style="color:green">index.html</b> to view!
    </p>
</div>
<br/>
<div>  
    <p style="font-size:20px;text-align:left;">
        <b>B3 Workshop preso: <span style="color:blue;">https://github.com/drbulu/intro_to_r</b></span>
    </p>
    <br/>
    <p style="font-size:20px;text-align:left;">
